...
function extractGitHubInfo(githubUrl: string): { owner: string; repo: string; path: string } {
...
async function fetchReadme(octokit: Octokit, owner: string, repo: string, path: string): Promise<string> {
    try {
...
async function fetchPackageJson(octokit: Octokit, owner: string, repo: string, path: string): Promise<any> {
    try {
...
async function processGitHubUrl(githubUrl: string, octokit: Octokit): Promise<void> {
