...
const hasRequiredEnvVars = process.env.SLACK_BOT_TOKEN && process.env.SLACK_CHANNEL_ID;
...
describe('Slack SDK Integration Tests', () => {
    ...
    describe('Message Operations', () => {
        ...
        itIfEnvVars('should send a message with custom username and emoji', async () => {
            const response = await slackSDK.sendMessage({
                channel: CHANNEL_ID,
    ...
    describe('File Operations', () => {
        itIfEnvVars('should upload text content as a file', async () => {
            const testContent = 'This is test content for the file upload.\nIt can span multiple lines.\nTesting file upload functionality.';
            ...
            if (response.file) {
                ...
                expect(response.file.title).toBe('Test File Upload from Automated Tests');
            }
        });
    });
