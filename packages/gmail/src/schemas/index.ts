...
export const GmailSDKConfigSchema = z.object({
  accessToken: z.string().optional().describe('The access token for the Google OAuth application'),
  refreshToken: z.string().optional().describe('The refresh token for the Google OAuth application'),
  clientId: z.string().describe('The client ID for the Google OAuth application'),
  clientSecret: z.string().describe('The client secret for the Google OAuth application'),
  redirectUri: z.string().url().describe('The redirect URI for the Google OAuth flow'),
  userId: z.string().optional().default('me').describe('The user ID to use for API requests'),
});
...
export const MessageSchema = z.object({
  ...
  labelIds: z.array(z.string()).optional().describe('List of IDs of labels applied to this message'),
  ...
  payload: z.object({
    ...
    body: z.object({
      data: z.string().optional().describe('The body data of the message, in base64url encoding'),
    }).optional(),
...
export const ThreadSchema = z.object({
  ...
  snippet: z.string().describe('A short part of the message text'),
  messages: z.array(MessageSchema).optional().describe('The list of messages in the thread'),
});
