...
export const BranchParamsSchema = z.object({
  ...
  baseBranch: z
    .string()
    .describe('Name of the branch to base the new branch on'),
});
...
export const RepoParamsSchema = z.object({
  ...
  includeAllBranches: z
    .boolean()
    .optional()
    .describe('Whether to include all branches'),
  privateRepo: z
    .boolean()
    .optional()
  ...
  description: z
    .string()
    .optional()
    .describe('Description of the new repository'),
});
